    ...
    <section className="py-16 bg-amber-50">
      <div className="container mx-auto px-4">
          ...
          {tools.map((tool, index) => (
            ...
            >
              <div className="flex justify-center mb-4">
                <div
                  className={`w-16 h-16 rounded-full bg-amber-100 flex items-center justify-center ${tool.animation}`}
                >
        ...
        <div className="bg-gradient-to-r from-amber-500 to-amber-600 rounded-xl p-8 text-white text-center">
          ...
          <Button
            size="lg"
            className="bg-white hover:bg-amber-50 text-amber-600 hover:text-amber-700 text-xl px-8 py-6 animate-bounce relative border border-amber-200"
            onClick={handleStartGame}
          >
            <span className="absolute -top-2 -right-2 bg-amber-700 text-amber-100 text-xs font-bold px-2 py-1 rounded-full border-2 border-white">
              18+
            </span>
