...
export const metadata: Metadata = {
  title: "Novrelis - Free Social Platform",
  description:
  ...
  keywords: "free game, social platform, skiing, winter, educational game, no money, virtual points, free to use",
  openGraph: {
    title: "Novrelis - Free Social Platform",
    description:
  ...
  return (
    <html lang="en-CA" suppressHydrationWarning>
      <head>
        ...
        <meta name="subject" content="Skiing Simulation" />
